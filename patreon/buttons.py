...
async def inline_handler(call: types.CallbackQuery, state: FSMContext):
    if call.data == 'crypts':
        ...
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Выберите криптовалюту, в которой вы хотите задонатить.", reply_markup=crypto_menu())
    elif call.data == 'v_btc':
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Введите сумму доната в $.\n\nМинимальная сумма — 0.70$\nОтменить операцию — <code>/cancel</code> ", parse_mode='HTML')
        ...
        try:
            ...
            await bot.send_message(call.message.chat.id, f"<strong>{datetime.strftime(datetime.now(msk), '%d.%m.%Y %H:%M')}</strong>\n\n" \
        ...
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text=f"Нет так нет!. Платёж отменён.")
        ...
        f"Благодарность от нас\n2. Закрытый чат в Telegram\n\nВыберете период подписки:", reply_markup=sub_period(1))
        ...
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Вы уверены, что хотите оформить подписку {name_sub} на {dat_text} за <strong>{summ}$ ({converted_amount} BTC)?</strong>", reply_markup=accept_sub(lvl, dat, 'BTC'),
        parse_mode='HTML')
        ...
        if lvl == '1':
            ...
            name_sub = '«Спонсор»'
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Выберете способ оплаты подписки {name_sub} на 1 месяц.", reply_markup=crypto_sub_menu(lvl, dat))
        ...
        if lvl == '1':
            ...
            name_sub = '«Спонсор»'
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Выберете способ оплаты подписки {name_sub} на 3 месяца.", reply_markup=crypto_sub_menu(lvl, dat))
        ...
        if lvl == '1':
            ...
            name_sub = '«Спонсор»'
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Выберете способ оплаты подписки {name_sub} на 6 месяцев.", reply_markup=crypto_sub_menu(lvl, dat))
        ...
        if lvl == '1':
            ...
            name_sub = '«Спонсор»'
        await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
        text=f"Выберете способ оплаты подписки {name_sub} на 12 месяцев.", reply_markup=crypto_sub_menu(lvl, dat))
        ...
        print(inf)
        if not inf:
            await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text=f"К сожалению, Вы не можете войти в чат" \
